...
var narrative_texts = [
	...
	"The agencies of Protagonism, Big Decisions, Exploratory, Weak interactive, Aesthetic, Reflective choices, Grasp, Velocity, Challenge, Tactics and strategy, Meta, Possibility, Focus, Identity, Creative, and Negative.",
